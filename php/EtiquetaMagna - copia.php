...
$of2 = "";
  QRcode::png("111862179901PV4B-K61630-DA", '../tmp/magna111862179901PV4B-K61630-DA.png'); 

    list($width, $height, $type, $attr) = getimagesize('../tmp/magna111862179901PV4B-K61630-DA.png');
...
$imagefactor=$width/$height;
 ...
 //$pdf->Image('../tmp/'.$of2.'.png', 182*$factorx+$despx,   0*$factory+$despy+1,15*$factorx*$imagefactor);
  ...
  $pdf->Image('../tmp/magna111862179901PV4B-K61630-DA.png', 150*$factorx+$despx, 20*$factory, 130*$factorx*$imagefactor);
...
$pdf->Text( 20*$factorx+$despx, 110*$factory  , "PV4B-K61630-DA");
