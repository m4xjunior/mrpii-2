...
async function GET(request) {
    try {
        ...
        console.log('📊 Resumen mensual estimado:', {
            ...data,
            calculo_perdidas: costoPromedioNok > 0 ? `${estimatedMonthlyNok} NOK × €${costoPromedioNok.toFixed(2)} = €${(estimatedMonthlyNok * costoPromedioNok).toFixed(2)}` : `${estimatedMonthlyNok} NOK × €0.00 = €0.00 (sin productos activos)`,
